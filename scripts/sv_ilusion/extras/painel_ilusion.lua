...
local caminhosImagens = {
    imagem1 = pathPastaImagens .. "fundoum",
    imagem2 = pathPastaImagens .. "fundodois",
    imagem3 = pathPastaImagens .. "fundotreis",
    imagem4 = pathPastaImagens .. "fundoquatro",
    imagem5 = pathPastaImagens .. "fundocinco"
}
