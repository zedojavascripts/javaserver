...
local ABAS_DISTANCIA_ESQ   = "18"   -- Move o bloco de abas para a esquerda ou direita
...
local RODAPE_DISTANCIA_BOT = "65"   -- Distância fixa de todos os botões em relação ao fundo
